...
async function createClients() {
  // Crear algunos clientes de ejemplo con todos los campos nuevos
  const clientes = [
    {
      rut: '12345678-9',
      tipo_cliente: 'empresa',
      nombre: 'Textiles del Sur Ltda.',
      nombre_fantasia: 'Textiles del Sur',
      ...
      // Contacto de pago
      contacto_pago: 'Juan Pérez',
      email_pago: 'pagos@textilesdelsur.cl',
      telefono_pago: '+56 9 87654321',
      // Contacto comercial
      contacto_comercial: 'María González',
      email_comercial: 'ventas@textilesdelsur.cl',
      // Configuración de crédito
      descuento_default: 5.00,
      linea_credito: 2000000,
      dias_credito: 30,
      forma_pago_default: '30 días',
      lista_precios: 'Lista A',
      restringir_si_vencido: true,
      dias_adicionales_morosidad: 5,
      activo: true,
    ...
    },
    {
      ...
      nombre_fantasia: 'ABC Confecciones',
      ...
      ciudad: 'Santiago',
      comuna: 'Providencia',
      telefono: '+56 2 3456789',
      celular: '+56 9 23456789',
      email: 'contacto@confeccionesabc.cl',
      contacto_pago: 'Carlos Silva',
      email_pago: 'finanzas@confeccionesabc.cl',
      contacto_comercial: 'Ana López',
      email_comercial: 'compras@confeccionesabc.cl',
      descuento_default: 10.00,
      linea_credito: 5000000,
      dias_credito: 60,
      forma_pago_default: '60 días',
      lista_precios: 'Lista B',
    ...
    },
    {
      rut: '77888999-K',
      tipo_cliente: 'empresa',
      nombre: 'Tapicerías Premium',
      nombre_fantasia: 'Tapicerías Premium',
      codigo_cliente: 'CLI004',
      razon_social: 'Tapicerías Premium SpA',
      giro: 'Fabricación de muebles tapizados',
      direccion: 'Av. Industrial 789',
      ciudad: 'Santiago',
      comuna: 'San Bernardo',
      telefono: '+56 2 4567890',
      celular: '+56 9 34567890',
      email: 'info@tapiceriaspremium.cl',
      contacto_pago: 'Pedro Muñoz',
      email_pago: 'cobranzas@tapiceriaspremium.cl',
      telefono_pago: '+56 9 45678901',
      contacto_comercial: 'Laura Torres',
      email_comercial: 'pedidos@tapiceriaspremium.cl',
      descuento_default: 15.00,
      linea_credito: 10000000,
      dias_credito: 90,
      forma_pago_default: '90 días',
      lista_precios: 'Lista Premium',
      restringir_si_vencido: true,
      dias_adicionales_morosidad: 10,
      activo: true,
      datos_completos: true
    }
  ];
